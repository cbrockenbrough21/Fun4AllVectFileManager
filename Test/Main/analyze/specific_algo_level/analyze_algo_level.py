...
df = df[(df["Algorithm"] == 1) & (df["Compression Level"] == 5)]
...
df.to_csv("algo1_level5_results_with_percentage_changes.csv", index=False)
...
plt.title("Algo 1 Level 5: % Change in Write Time vs File Size", fontsize=14)
...
# Save and Show Plot
plt.savefig("algo1_level5_tradeoffs.png", dpi=300)
