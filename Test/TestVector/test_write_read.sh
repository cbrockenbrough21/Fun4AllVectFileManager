...
autoflush_values=(0 2500 5000)  # Add your desired AutoFlush values here
  ...
  do
    ...
    do
      ...
      do
        ...
        # Run ConvertToVect.C with the current parameters
        result=$(root -b -q "ConvertToVect.C+($algo, $level, $basket_size, $autoflush)")
