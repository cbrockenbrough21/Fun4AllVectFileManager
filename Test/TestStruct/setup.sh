...
export LD_LIBRARY_PATH=/project/ptgroup/Catherine/Fun4AllVectFileManager/StructDef/build:$LD_LIBRARY_PATH
export ROOT_INCLUDE_PATH=/project/ptgroup/Catherine/Fun4AllVectFileManager/StructDef/src:$ROOT_INCLUDE_PATH
